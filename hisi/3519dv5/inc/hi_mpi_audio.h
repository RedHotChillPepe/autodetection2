...
/* Audio function api. */
hi_s32 hi_mpi_audio_init(hi_void);
hi_s32 hi_mpi_audio_exit(hi_void);
...
hi_s32 hi_mpi_ai_set_dmic_gain(hi_audio_dev ai_dev, hi_s32 gain);
hi_s32 hi_mpi_ai_get_dmic_gain(hi_audio_dev ai_dev, hi_s32 *gain);
...
hi_s32 hi_mpi_ai_get_raw_frame(hi_audio_dev ai_dev, hi_ai_chn ai_chn, hi_audio_frame *frame,
    hi_aec_frame *aec_frame, hi_s32 milli_sec);
hi_s32 hi_mpi_ai_release_raw_frame(hi_audio_dev ai_dev, hi_ai_chn ai_chn, const hi_audio_frame *frame,
    const hi_aec_frame *aec_frame);
