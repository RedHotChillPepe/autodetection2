...
hi_s32 hi_mpi_venc_request_vi(hi_venc_chn chn);
...
hi_s32 hi_mpi_venc_set_jpeg_dering_attr(hi_venc_chn chn, const hi_venc_jpeg_dering_attr dering_attr);
hi_s32 hi_mpi_venc_get_jpeg_dering_attr(hi_venc_chn chn, hi_venc_jpeg_dering_attr *dering_attr);
...
hi_s32 hi_mpi_venc_set_adv_deblur(hi_venc_chn chn, const hi_venc_adv_deblur *adv_deblur);
hi_s32 hi_mpi_venc_get_adv_deblur(hi_venc_chn chn, hi_venc_adv_deblur *adv_deblur);
...
hi_s32 hi_mpi_venc_set_quality_balance(hi_venc_chn chn, const hi_venc_quality_balance *quality_balance);
hi_s32 hi_mpi_venc_get_quality_balance(hi_venc_chn chn, hi_venc_quality_balance *quality_balance);
hi_s32 hi_mpi_venc_set_watermark(hi_venc_chn chn, const hi_venc_watermark *watermark);
hi_s32 hi_mpi_venc_get_watermark(hi_venc_chn chn, hi_venc_watermark *watermark);
hi_s32 hi_mpi_venc_set_watermark_roi(hi_venc_chn chn, const hi_venc_watermark_roi *watermark_roi);
hi_s32 hi_mpi_venc_get_watermark_roi(hi_venc_chn chn, hi_venc_watermark_roi *watermark_roi);
hi_s32 hi_mpi_venc_omx_send_frame(hi_venc_chn chn, const hi_omx_user_frame_info *frame, hi_s32 milli_sec);
hi_s32 hi_mpi_venc_enable_jpeg_dblk(hi_venc_chn chn, hi_bool enable);
