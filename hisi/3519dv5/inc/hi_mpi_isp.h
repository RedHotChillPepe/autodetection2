...
hi_s32 hi_mpi_isp_mem_share(hi_vi_pipe vi_pipe, hi_s32 pid);
hi_s32 hi_mpi_isp_mem_unshare(hi_vi_pipe vi_pipe, hi_s32 pid);
hi_s32 hi_mpi_isp_mem_share_all(hi_vi_pipe vi_pipe);
hi_s32 hi_mpi_isp_mem_unshare_all(hi_vi_pipe vi_pipe);
hi_s32 hi_mpi_isp_sensor_reg_callback(hi_vi_pipe vi_pipe, hi_isp_sns_attr_info *sns_attr_info,
                                      const hi_isp_sns_register *sns_register);
...
hi_s32 hi_mpi_isp_set_fe_roi_cfg(hi_vi_pipe vi_pipe, const hi_isp_fe_roi_cfg *fe_roi_cfg);
hi_s32 hi_mpi_isp_get_fe_roi_cfg(hi_vi_pipe vi_pipe, hi_isp_fe_roi_cfg *fe_roi_cfg);
...
hi_s32 hi_mpi_isp_set_lblc_attr(hi_vi_pipe vi_pipe, const hi_isp_lblc_attr *lblc_attr);
hi_s32 hi_mpi_isp_get_lblc_attr(hi_vi_pipe vi_pipe, hi_isp_lblc_attr *lblc_attr);

hi_s32 hi_mpi_isp_set_lblc_lut_attr(hi_vi_pipe vi_pipe, const hi_isp_lblc_lut_attr *lblc_lut_attr);
hi_s32 hi_mpi_isp_get_lblc_lut_attr(hi_vi_pipe vi_pipe, hi_isp_lblc_lut_attr *lblc_lut_attr);
...
hi_s32 hi_mpi_isp_set_cac_attr(hi_vi_pipe vi_pipe, const hi_isp_cac_attr *cac_attr);
hi_s32 hi_mpi_isp_get_cac_attr(hi_vi_pipe vi_pipe, hi_isp_cac_attr *cac_attr);
...
hi_s32 hi_mpi_isp_calc_flicker_type(hi_vi_pipe vi_pipe, hi_isp_calc_flicker_input *input_param,
                                    ...
                                    hi_u32 array_size);
hi_s32 hi_mpi_isp_ir_auto(hi_vi_pipe vi_pipe, hi_isp_ir_auto_attr *ir_attr);
...
hi_s32 hi_mpi_isp_set_detail_stats_cfg(hi_vi_pipe vi_pipe,
    const hi_isp_detail_stats_cfg *detail_stats_cfg);
hi_s32 hi_mpi_isp_get_detail_stats_cfg(hi_vi_pipe vi_pipe, hi_isp_detail_stats_cfg *detail_stats_cfg);
hi_s32 hi_mpi_isp_get_detail_stats(hi_vi_pipe vi_pipe, hi_isp_detail_stats *detail_stats);
