...
hi_s32 hi_mpi_aibnr_set_model_attr(hi_bool is_wdr_mode, const hi_aibnr_model_attr *attr);
hi_s32 hi_mpi_aibnr_get_model_attr(hi_bool is_wdr_mode, hi_aibnr_model_attr *attr);
hi_s32 hi_mpi_aibnr_query_model_list(hi_aibnr_model_list *list);
