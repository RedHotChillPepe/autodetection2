...
hi_s32 hi_mpi_aidrc_get_output_frame(hi_s32 pipe,          hi_video_frame_info *frame,
    hi_aiisp_mem_info *out_data[], hi_u32 out_data_num, hi_s32 milli_sec);
hi_s32 hi_mpi_aidrc_release_output_frame(hi_s32 pipe, hi_video_frame_info *frame);
